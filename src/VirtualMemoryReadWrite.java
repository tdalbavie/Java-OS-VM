...
public class VirtualMemoryReadWrite extends UserlandProcess {
    @Override
    public void main()
    {
        int i = 0;
        while(i != 100)
        {
            ...
            {
                System.out.println("VirtualReadWriteProcess: Read/Write test passed.");
            }
            else
            {
                System.out.println("VirtualReadWriteProcess: Read/Write test failed.");
            }
